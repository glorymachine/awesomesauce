...
enctype="application/x-www-form-urlencoded" autocomplete="off">
                        <div class="form-group">
                          <textarea class="form-control" rows="3" id="omsidNum" name="omsidNum" placeholder="Enter OMSIDs with each one on a separate line, no commas."><?php if(!empty($_POST['omsidNum'])){ echo $_POST['omsidNum']; }?></textarea>
                        </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <?php
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                            <a href="<?php if(!empty($gURL)){echo $gURL;}else{echo $url;} ?>" target="_blank">
                                <img class="img-thumbnail img-responsive" src="<?php if(!empty($image)){echo $image;}else{echo 'images/noimage.gif';} ?>" height="40%" id="mediaElement">
                            </a>
                    ...
                    <?php
                      if($total === $i){
                        echo "<script>msnry.reloadItems();</script>";
                      }
                    ?>
                    <?php } ?>
                  </div><!-- /.row -->
...
?>
<script>
var container = document.querySelector('.masonryHouse');
var msnry = new Masonry( container, {
  itemSelector: '.masonryBrick',
  columnWidth: '.masonryBrick',
